    ...
    class ResourceGenerator
      ...
      def self.set_fields!(resource, namespace, embedded=0)
        ...
        resource.class::METADATA.each do |key, meta|
          ...
          if type == 'string' || type == 'markdown'
            ...
            gen = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><div>#{SecureRandom.base64}</div></div>"
          elsif type == 'uri'
      ...
      def self.apply_invariants!(resource)
        ...
        #  resource.participant.each{|p| p.type=[ minimal_codeableconcept('http://hl7.org/fhir/participant-type','emergency') ] }
          resource.participant.each{|p| p.type=[ minimal_codeableconcept('http://terminology.hl7.org/CodeSystem/v3-ParticipationType','ATND') ] }
        ...
        #  resource.participantType = [ minimal_codeableconcept('http://hl7.org/fhir/participant-type','emergency') ]
          resource.participantType = [ minimal_codeableconcept('http://terminology.hl7.org/CodeSystem/v3-ParticipationType','ATND') ]
